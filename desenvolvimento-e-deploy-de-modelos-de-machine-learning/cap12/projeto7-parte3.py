...
# Script 3: Estratégia 1 de Mitigação de Data Drift - Retreinar o Modelo com os Novos Dados e Otimizar Hiperparâmetros
...
def dsa_retreina_modelo(X_train, y_train, X_new, y_new):
    ...
    # Cria um novo modelo
    modelo_dsa = RandomForestClassifier(random_state = 42)
...
modelo_arquivo = 'modelo_dsa_v2.pkl'
scaler_arquivo = 'scaler_dsa_v2.pkl'
