...
# Script 4: Estratégia 3 de Mitigação de Data Drift - Retreinar o Modelo com os Novos Dados, Otimizar Hiperparâmetros, Combinar Diferentes Algoritmos
...
modelo_arquivo = 'modelo_dsa_v4.pkl'
scaler_arquivo = 'scaler_dsa_v4.pkl'
